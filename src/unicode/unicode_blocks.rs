...
// Generated by awk -f src/unicode/gen-blocks.awk Blocks.txt > src/unicode/unicode_blocks.rs

use crate::unicode::UnicodeBlock;
...
pub const CYRILLIC: UnicodeBlock =
    UnicodeBlock { name: "Cyrillic", start: 0x0400, end: 0x04FF };
pub const CYRILLIC_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Cyrillic Supplement", start: 0x0500, end: 0x052F };
pub const ARMENIAN: UnicodeBlock =
    UnicodeBlock { name: "Armenian", start: 0x0530, end: 0x058F };
pub const HEBREW: UnicodeBlock =
    UnicodeBlock { name: "Hebrew", start: 0x0590, end: 0x05FF };
pub const ARABIC: UnicodeBlock =
    UnicodeBlock { name: "Arabic", start: 0x0600, end: 0x06FF };
pub const SYRIAC: UnicodeBlock =
    UnicodeBlock { name: "Syriac", start: 0x0700, end: 0x074F };
pub const ARABIC_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Arabic Supplement", start: 0x0750, end: 0x077F };
pub const THAANA: UnicodeBlock =
    UnicodeBlock { name: "Thaana", start: 0x0780, end: 0x07BF };
pub const NKO: UnicodeBlock =
    UnicodeBlock { name: "NKo", start: 0x07C0, end: 0x07FF };
pub const SAMARITAN: UnicodeBlock =
    UnicodeBlock { name: "Samaritan", start: 0x0800, end: 0x083F };
pub const MANDAIC: UnicodeBlock =
    UnicodeBlock { name: "Mandaic", start: 0x0840, end: 0x085F };
pub const SYRIAC_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Syriac Supplement", start: 0x0860, end: 0x086F };
pub const ARABIC_EXTENDED_B: UnicodeBlock =
    UnicodeBlock { name: "Arabic Extended-B", start: 0x0870, end: 0x089F };
pub const ARABIC_EXTENDED_A: UnicodeBlock =
    UnicodeBlock { name: "Arabic Extended-A", start: 0x08A0, end: 0x08FF };
pub const DEVANAGARI: UnicodeBlock =
    UnicodeBlock { name: "Devanagari", start: 0x0900, end: 0x097F };
pub const BENGALI: UnicodeBlock =
    UnicodeBlock { name: "Bengali", start: 0x0980, end: 0x09FF };
pub const GURMUKHI: UnicodeBlock =
    UnicodeBlock { name: "Gurmukhi", start: 0x0A00, end: 0x0A7F };
pub const GUJARATI: UnicodeBlock =
    UnicodeBlock { name: "Gujarati", start: 0x0A80, end: 0x0AFF };
pub const ORIYA: UnicodeBlock =
    UnicodeBlock { name: "Oriya", start: 0x0B00, end: 0x0B7F };
pub const TAMIL: UnicodeBlock =
    UnicodeBlock { name: "Tamil", start: 0x0B80, end: 0x0BFF };
pub const TELUGU: UnicodeBlock =
    UnicodeBlock { name: "Telugu", start: 0x0C00, end: 0x0C7F };
pub const KANNADA: UnicodeBlock =
    UnicodeBlock { name: "Kannada", start: 0x0C80, end: 0x0CFF };
pub const MALAYALAM: UnicodeBlock =
    UnicodeBlock { name: "Malayalam", start: 0x0D00, end: 0x0D7F };
pub const SINHALA: UnicodeBlock =
    UnicodeBlock { name: "Sinhala", start: 0x0D80, end: 0x0DFF };
pub const THAI: UnicodeBlock =
    UnicodeBlock { name: "Thai", start: 0x0E00, end: 0x0E7F };
pub const LAO: UnicodeBlock =
    UnicodeBlock { name: "Lao", start: 0x0E80, end: 0x0EFF };
pub const TIBETAN: UnicodeBlock =
    UnicodeBlock { name: "Tibetan", start: 0x0F00, end: 0x0FFF };
pub const MYANMAR: UnicodeBlock =
    UnicodeBlock { name: "Myanmar", start: 0x1000, end: 0x109F };
pub const GEORGIAN: UnicodeBlock =
    UnicodeBlock { name: "Georgian", start: 0x10A0, end: 0x10FF };
pub const HANGUL_JAMO: UnicodeBlock =
    UnicodeBlock { name: "Hangul Jamo", start: 0x1100, end: 0x11FF };
pub const ETHIOPIC: UnicodeBlock =
    UnicodeBlock { name: "Ethiopic", start: 0x1200, end: 0x137F };
pub const ETHIOPIC_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Ethiopic Supplement", start: 0x1380, end: 0x139F };
pub const CHEROKEE: UnicodeBlock =
    UnicodeBlock { name: "Cherokee", start: 0x13A0, end: 0x13FF };
pub const UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS: UnicodeBlock = UnicodeBlock {
    name: "Unified Canadian Aboriginal Syllabics",
    start: 0x1400,
    end: 0x167F,
};
pub const OGHAM: UnicodeBlock =
    UnicodeBlock { name: "Ogham", start: 0x1680, end: 0x169F };
pub const RUNIC: UnicodeBlock =
    UnicodeBlock { name: "Runic", start: 0x16A0, end: 0x16FF };
pub const TAGALOG: UnicodeBlock =
    UnicodeBlock { name: "Tagalog", start: 0x1700, end: 0x171F };
pub const HANUNOO: UnicodeBlock =
    UnicodeBlock { name: "Hanunoo", start: 0x1720, end: 0x173F };
pub const BUHID: UnicodeBlock =
    UnicodeBlock { name: "Buhid", start: 0x1740, end: 0x175F };
pub const TAGBANWA: UnicodeBlock =
    UnicodeBlock { name: "Tagbanwa", start: 0x1760, end: 0x177F };
pub const KHMER: UnicodeBlock =
    UnicodeBlock { name: "Khmer", start: 0x1780, end: 0x17FF };
pub const MONGOLIAN: UnicodeBlock =
    UnicodeBlock { name: "Mongolian", start: 0x1800, end: 0x18AF };
pub const UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED: UnicodeBlock =
    UnicodeBlock {
        name: "Unified Canadian Aboriginal Syllabics Extended",
        start: 0x18B0,
        end: 0x18FF,
    };
pub const LIMBU: UnicodeBlock =
    UnicodeBlock { name: "Limbu", start: 0x1900, end: 0x194F };
pub const TAI_LE: UnicodeBlock =
    UnicodeBlock { name: "Tai Le", start: 0x1950, end: 0x197F };
pub const NEW_TAI_LUE: UnicodeBlock =
    UnicodeBlock { name: "New Tai Lue", start: 0x1980, end: 0x19DF };
pub const KHMER_SYMBOLS: UnicodeBlock =
    UnicodeBlock { name: "Khmer Symbols", start: 0x19E0, end: 0x19FF };
pub const BUGINESE: UnicodeBlock =
    UnicodeBlock { name: "Buginese", start: 0x1A00, end: 0x1A1F };
pub const TAI_THAM: UnicodeBlock =
    UnicodeBlock { name: "Tai Tham", start: 0x1A20, end: 0x1AAF };
pub const COMBINING_DIACRITICAL_MARKS_EXTENDED: UnicodeBlock = UnicodeBlock {
    name: "Combining Diacritical Marks Extended",
    start: 0x1AB0,
    end: 0x1AFF,
};
pub const BALINESE: UnicodeBlock =
    UnicodeBlock { name: "Balinese", start: 0x1B00, end: 0x1B7F };
pub const SUNDANESE: UnicodeBlock =
    UnicodeBlock { name: "Sundanese", start: 0x1B80, end: 0x1BBF };
pub const BATAK: UnicodeBlock =
    UnicodeBlock { name: "Batak", start: 0x1BC0, end: 0x1BFF };
pub const LEPCHA: UnicodeBlock =
    UnicodeBlock { name: "Lepcha", start: 0x1C00, end: 0x1C4F };
pub const OL_CHIKI: UnicodeBlock =
    UnicodeBlock { name: "Ol Chiki", start: 0x1C50, end: 0x1C7F };
pub const CYRILLIC_EXTENDED_C: UnicodeBlock =
    UnicodeBlock { name: "Cyrillic Extended-C", start: 0x1C80, end: 0x1C8F };
pub const GEORGIAN_EXTENDED: UnicodeBlock =
    UnicodeBlock { name: "Georgian Extended", start: 0x1C90, end: 0x1CBF };
pub const SUNDANESE_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Sundanese Supplement", start: 0x1CC0, end: 0x1CCF };
pub const VEDIC_EXTENSIONS: UnicodeBlock =
    UnicodeBlock { name: "Vedic Extensions", start: 0x1CD0, end: 0x1CFF };
pub const PHONETIC_EXTENSIONS: UnicodeBlock =
    UnicodeBlock { name: "Phonetic Extensions", start: 0x1D00, end: 0x1D7F };
...
pub const GREEK_EXTENDED: UnicodeBlock =
    UnicodeBlock { name: "Greek Extended", start: 0x1F00, end: 0x1FFF };
...
pub const NUMBER_FORMS: UnicodeBlock =
    UnicodeBlock { name: "Number Forms", start: 0x2150, end: 0x218F };
pub const ARROWS: UnicodeBlock =
...
pub const CONTROL_PICTURES: UnicodeBlock =
    UnicodeBlock { name: "Control Pictures", start: 0x2400, end: 0x243F };
...
pub const BOX_DRAWING: UnicodeBlock =
    UnicodeBlock { name: "Box Drawing", start: 0x2500, end: 0x257F };
pub const BLOCK_ELEMENTS: UnicodeBlock =
    UnicodeBlock { name: "Block Elements", start: 0x2580, end: 0x259F };
pub const GEOMETRIC_SHAPES: UnicodeBlock =
    UnicodeBlock { name: "Geometric Shapes", start: 0x25A0, end: 0x25FF };
pub const MISCELLANEOUS_SYMBOLS: UnicodeBlock =
    UnicodeBlock { name: "Miscellaneous Symbols", start: 0x2600, end: 0x26FF };
pub const DINGBATS: UnicodeBlock =
    UnicodeBlock { name: "Dingbats", start: 0x2700, end: 0x27BF };
...
pub const SUPPLEMENTAL_ARROWS_A: UnicodeBlock =
    UnicodeBlock { name: "Supplemental Arrows-A", start: 0x27F0, end: 0x27FF };
pub const BRAILLE_PATTERNS: UnicodeBlock =
    UnicodeBlock { name: "Braille Patterns", start: 0x2800, end: 0x28FF };
pub const SUPPLEMENTAL_ARROWS_B: UnicodeBlock =
    UnicodeBlock { name: "Supplemental Arrows-B", start: 0x2900, end: 0x297F };
...
pub const GLAGOLITIC: UnicodeBlock =
    UnicodeBlock { name: "Glagolitic", start: 0x2C00, end: 0x2C5F };
pub const LATIN_EXTENDED_C: UnicodeBlock =
    UnicodeBlock { name: "Latin Extended-C", start: 0x2C60, end: 0x2C7F };
pub const COPTIC: UnicodeBlock =
    UnicodeBlock { name: "Coptic", start: 0x2C80, end: 0x2CFF };
pub const GEORGIAN_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Georgian Supplement", start: 0x2D00, end: 0x2D2F };
pub const TIFINAGH: UnicodeBlock =
    UnicodeBlock { name: "Tifinagh", start: 0x2D30, end: 0x2D7F };
pub const ETHIOPIC_EXTENDED: UnicodeBlock =
    UnicodeBlock { name: "Ethiopic Extended", start: 0x2D80, end: 0x2DDF };
pub const CYRILLIC_EXTENDED_A: UnicodeBlock =
    UnicodeBlock { name: "Cyrillic Extended-A", start: 0x2DE0, end: 0x2DFF };
...
pub const KANGXI_RADICALS: UnicodeBlock =
    UnicodeBlock { name: "Kangxi Radicals", start: 0x2F00, end: 0x2FDF };
...
pub const HIRAGANA: UnicodeBlock =
    UnicodeBlock { name: "Hiragana", start: 0x3040, end: 0x309F };
pub const KATAKANA: UnicodeBlock =
    UnicodeBlock { name: "Katakana", start: 0x30A0, end: 0x30FF };
pub const BOPOMOFO: UnicodeBlock =
    UnicodeBlock { name: "Bopomofo", start: 0x3100, end: 0x312F };
pub const HANGUL_COMPATIBILITY_JAMO: UnicodeBlock = UnicodeBlock {
    name: "Hangul Compatibility Jamo",
    start: 0x3130,
    end: 0x318F,
};
pub const KANBUN: UnicodeBlock =
    UnicodeBlock { name: "Kanbun", start: 0x3190, end: 0x319F };
pub const BOPOMOFO_EXTENDED: UnicodeBlock =
    UnicodeBlock { name: "Bopomofo Extended", start: 0x31A0, end: 0x31BF };
pub const CJK_STROKES: UnicodeBlock =
    UnicodeBlock { name: "CJK Strokes", start: 0x31C0, end: 0x31EF };
...
pub const CJK_COMPATIBILITY: UnicodeBlock =
    UnicodeBlock { name: "CJK Compatibility", start: 0x3300, end: 0x33FF };
...
pub const YI_SYLLABLES: UnicodeBlock =
    UnicodeBlock { name: "Yi Syllables", start: 0xA000, end: 0xA48F };
pub const YI_RADICALS: UnicodeBlock =
    UnicodeBlock { name: "Yi Radicals", start: 0xA490, end: 0xA4CF };
pub const LISU: UnicodeBlock =
    UnicodeBlock { name: "Lisu", start: 0xA4D0, end: 0xA4FF };
pub const VAI: UnicodeBlock =
    UnicodeBlock { name: "Vai", start: 0xA500, end: 0xA63F };
pub const CYRILLIC_EXTENDED_B: UnicodeBlock =
    UnicodeBlock { name: "Cyrillic Extended-B", start: 0xA640, end: 0xA69F };
pub const BAMUM: UnicodeBlock =
    UnicodeBlock { name: "Bamum", start: 0xA6A0, end: 0xA6FF };
pub const MODIFIER_TONE_LETTERS: UnicodeBlock =
    UnicodeBlock { name: "Modifier Tone Letters", start: 0xA700, end: 0xA71F };
pub const LATIN_EXTENDED_D: UnicodeBlock =
    UnicodeBlock { name: "Latin Extended-D", start: 0xA720, end: 0xA7FF };
pub const SYLOTI_NAGRI: UnicodeBlock =
    UnicodeBlock { name: "Syloti Nagri", start: 0xA800, end: 0xA82F };
pub const COMMON_INDIC_NUMBER_FORMS: UnicodeBlock = UnicodeBlock {
    name: "Common Indic Number Forms",
    start: 0xA830,
    end: 0xA83F,
};
pub const PHAGS_PA: UnicodeBlock =
    UnicodeBlock { name: "Phags-pa", start: 0xA840, end: 0xA87F };
pub const SAURASHTRA: UnicodeBlock =
    UnicodeBlock { name: "Saurashtra", start: 0xA880, end: 0xA8DF };
pub const DEVANAGARI_EXTENDED: UnicodeBlock =
    UnicodeBlock { name: "Devanagari Extended", start: 0xA8E0, end: 0xA8FF };
pub const KAYAH_LI: UnicodeBlock =
    UnicodeBlock { name: "Kayah Li", start: 0xA900, end: 0xA92F };
pub const REJANG: UnicodeBlock =
    UnicodeBlock { name: "Rejang", start: 0xA930, end: 0xA95F };
pub const HANGUL_JAMO_EXTENDED_A: UnicodeBlock = UnicodeBlock {
    name: "Hangul Jamo Extended-A",
    start: 0xA960,
    end: 0xA97F,
};
pub const JAVANESE: UnicodeBlock =
    UnicodeBlock { name: "Javanese", start: 0xA980, end: 0xA9DF };
pub const MYANMAR_EXTENDED_B: UnicodeBlock =
    UnicodeBlock { name: "Myanmar Extended-B", start: 0xA9E0, end: 0xA9FF };
pub const CHAM: UnicodeBlock =
    UnicodeBlock { name: "Cham", start: 0xAA00, end: 0xAA5F };
pub const MYANMAR_EXTENDED_A: UnicodeBlock =
    UnicodeBlock { name: "Myanmar Extended-A", start: 0xAA60, end: 0xAA7F };
pub const TAI_VIET: UnicodeBlock =
    UnicodeBlock { name: "Tai Viet", start: 0xAA80, end: 0xAADF };
...
pub const ETHIOPIC_EXTENDED_A: UnicodeBlock =
    UnicodeBlock { name: "Ethiopic Extended-A", start: 0xAB00, end: 0xAB2F };
pub const LATIN_EXTENDED_E: UnicodeBlock =
    UnicodeBlock { name: "Latin Extended-E", start: 0xAB30, end: 0xAB6F };
pub const CHEROKEE_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Cherokee Supplement", start: 0xAB70, end: 0xABBF };
pub const MEETEI_MAYEK: UnicodeBlock =
    UnicodeBlock { name: "Meetei Mayek", start: 0xABC0, end: 0xABFF };
pub const HANGUL_SYLLABLES: UnicodeBlock =
    UnicodeBlock { name: "Hangul Syllables", start: 0xAC00, end: 0xD7AF };
...
pub const HIGH_SURROGATES: UnicodeBlock =
    UnicodeBlock { name: "High Surrogates", start: 0xD800, end: 0xDB7F };
...
pub const LOW_SURROGATES: UnicodeBlock =
    UnicodeBlock { name: "Low Surrogates", start: 0xDC00, end: 0xDFFF };
pub const PRIVATE_USE_AREA: UnicodeBlock =
    UnicodeBlock { name: "Private Use Area", start: 0xE000, end: 0xF8FF };
...
pub const VARIATION_SELECTORS: UnicodeBlock =
    UnicodeBlock { name: "Variation Selectors", start: 0xFE00, end: 0xFE0F };
pub const VERTICAL_FORMS: UnicodeBlock =
    UnicodeBlock { name: "Vertical Forms", start: 0xFE10, end: 0xFE1F };
pub const COMBINING_HALF_MARKS: UnicodeBlock =
    UnicodeBlock { name: "Combining Half Marks", start: 0xFE20, end: 0xFE2F };
...
pub const SMALL_FORM_VARIANTS: UnicodeBlock =
    UnicodeBlock { name: "Small Form Variants", start: 0xFE50, end: 0xFE6F };
...
pub const SPECIALS: UnicodeBlock =
    UnicodeBlock { name: "Specials", start: 0xFFF0, end: 0xFFFF };
pub const LINEAR_B_SYLLABARY: UnicodeBlock =
    UnicodeBlock { name: "Linear B Syllabary", start: 0x10000, end: 0x1007F };
pub const LINEAR_B_IDEOGRAMS: UnicodeBlock =
    UnicodeBlock { name: "Linear B Ideograms", start: 0x10080, end: 0x100FF };
pub const AEGEAN_NUMBERS: UnicodeBlock =
    UnicodeBlock { name: "Aegean Numbers", start: 0x10100, end: 0x1013F };
...
pub const ANCIENT_SYMBOLS: UnicodeBlock =
    UnicodeBlock { name: "Ancient Symbols", start: 0x10190, end: 0x101CF };
pub const PHAISTOS_DISC: UnicodeBlock =
    UnicodeBlock { name: "Phaistos Disc", start: 0x101D0, end: 0x101FF };
pub const LYCIAN: UnicodeBlock =
    UnicodeBlock { name: "Lycian", start: 0x10280, end: 0x1029F };
pub const CARIAN: UnicodeBlock =
    UnicodeBlock { name: "Carian", start: 0x102A0, end: 0x102DF };
...
pub const OLD_ITALIC: UnicodeBlock =
    UnicodeBlock { name: "Old Italic", start: 0x10300, end: 0x1032F };
pub const GOTHIC: UnicodeBlock =
    UnicodeBlock { name: "Gothic", start: 0x10330, end: 0x1034F };
pub const OLD_PERMIC: UnicodeBlock =
    UnicodeBlock { name: "Old Permic", start: 0x10350, end: 0x1037F };
pub const UGARITIC: UnicodeBlock =
    UnicodeBlock { name: "Ugaritic", start: 0x10380, end: 0x1039F };
pub const OLD_PERSIAN: UnicodeBlock =
    UnicodeBlock { name: "Old Persian", start: 0x103A0, end: 0x103DF };
pub const DESERET: UnicodeBlock =
    UnicodeBlock { name: "Deseret", start: 0x10400, end: 0x1044F };
pub const SHAVIAN: UnicodeBlock =
    UnicodeBlock { name: "Shavian", start: 0x10450, end: 0x1047F };
pub const OSMANYA: UnicodeBlock =
    UnicodeBlock { name: "Osmanya", start: 0x10480, end: 0x104AF };
pub const OSAGE: UnicodeBlock =
    UnicodeBlock { name: "Osage", start: 0x104B0, end: 0x104FF };
pub const ELBASAN: UnicodeBlock =
    UnicodeBlock { name: "Elbasan", start: 0x10500, end: 0x1052F };
pub const CAUCASIAN_ALBANIAN: UnicodeBlock =
    UnicodeBlock { name: "Caucasian Albanian", start: 0x10530, end: 0x1056F };
pub const VITHKUQI: UnicodeBlock =
    UnicodeBlock { name: "Vithkuqi", start: 0x10570, end: 0x105BF };
pub const TODHRI: UnicodeBlock =
    UnicodeBlock { name: "Todhri", start: 0x105C0, end: 0x105FF };
pub const LINEAR_A: UnicodeBlock =
    UnicodeBlock { name: "Linear A", start: 0x10600, end: 0x1077F };
pub const LATIN_EXTENDED_F: UnicodeBlock =
    UnicodeBlock { name: "Latin Extended-F", start: 0x10780, end: 0x107BF };
pub const CYPRIOT_SYLLABARY: UnicodeBlock =
    UnicodeBlock { name: "Cypriot Syllabary", start: 0x10800, end: 0x1083F };
pub const IMPERIAL_ARAMAIC: UnicodeBlock =
    UnicodeBlock { name: "Imperial Aramaic", start: 0x10840, end: 0x1085F };
pub const PALMYRENE: UnicodeBlock =
    UnicodeBlock { name: "Palmyrene", start: 0x10860, end: 0x1087F };
pub const NABATAEAN: UnicodeBlock =
    UnicodeBlock { name: "Nabataean", start: 0x10880, end: 0x108AF };
pub const HATRAN: UnicodeBlock =
    UnicodeBlock { name: "Hatran", start: 0x108E0, end: 0x108FF };
pub const PHOENICIAN: UnicodeBlock =
    UnicodeBlock { name: "Phoenician", start: 0x10900, end: 0x1091F };
pub const LYDIAN: UnicodeBlock =
    UnicodeBlock { name: "Lydian", start: 0x10920, end: 0x1093F };
pub const SIDETIC: UnicodeBlock =
    UnicodeBlock { name: "Sidetic", start: 0x10940, end: 0x1095F };
...
pub const MEROITIC_CURSIVE: UnicodeBlock =
    UnicodeBlock { name: "Meroitic Cursive", start: 0x109A0, end: 0x109FF };
pub const KHAROSHTHI: UnicodeBlock =
    UnicodeBlock { name: "Kharoshthi", start: 0x10A00, end: 0x10A5F };
pub const OLD_SOUTH_ARABIAN: UnicodeBlock =
    UnicodeBlock { name: "Old South Arabian", start: 0x10A60, end: 0x10A7F };
pub const OLD_NORTH_ARABIAN: UnicodeBlock =
    UnicodeBlock { name: "Old North Arabian", start: 0x10A80, end: 0x10A9F };
pub const MANICHAEAN: UnicodeBlock =
    UnicodeBlock { name: "Manichaean", start: 0x10AC0, end: 0x10AFF };
pub const AVESTAN: UnicodeBlock =
    UnicodeBlock { name: "Avestan", start: 0x10B00, end: 0x10B3F };
...
pub const PSALTER_PAHLAVI: UnicodeBlock =
    UnicodeBlock { name: "Psalter Pahlavi", start: 0x10B80, end: 0x10BAF };
pub const OLD_TURKIC: UnicodeBlock =
    UnicodeBlock { name: "Old Turkic", start: 0x10C00, end: 0x10C4F };
pub const OLD_HUNGARIAN: UnicodeBlock =
    UnicodeBlock { name: "Old Hungarian", start: 0x10C80, end: 0x10CFF };
pub const HANIFI_ROHINGYA: UnicodeBlock =
    UnicodeBlock { name: "Hanifi Rohingya", start: 0x10D00, end: 0x10D3F };
pub const GARAY: UnicodeBlock =
    UnicodeBlock { name: "Garay", start: 0x10D40, end: 0x10D8F };
pub const RUMI_NUMERAL_SYMBOLS: UnicodeBlock = UnicodeBlock {
    name: "Rumi Numeral Symbols",
    start: 0x10E60,
    end: 0x10E7F,
};
pub const YEZIDI: UnicodeBlock =
    UnicodeBlock { name: "Yezidi", start: 0x10E80, end: 0x10EBF };
pub const ARABIC_EXTENDED_C: UnicodeBlock =
    UnicodeBlock { name: "Arabic Extended-C", start: 0x10EC0, end: 0x10EFF };
pub const OLD_SOGDIAN: UnicodeBlock =
    UnicodeBlock { name: "Old Sogdian", start: 0x10F00, end: 0x10F2F };
pub const SOGDIAN: UnicodeBlock =
    UnicodeBlock { name: "Sogdian", start: 0x10F30, end: 0x10F6F };
pub const OLD_UYGHUR: UnicodeBlock =
    UnicodeBlock { name: "Old Uyghur", start: 0x10F70, end: 0x10FAF };
pub const CHORASMIAN: UnicodeBlock =
    UnicodeBlock { name: "Chorasmian", start: 0x10FB0, end: 0x10FDF };
pub const ELYMAIC: UnicodeBlock =
    UnicodeBlock { name: "Elymaic", start: 0x10FE0, end: 0x10FFF };
pub const BRAHMI: UnicodeBlock =
    UnicodeBlock { name: "Brahmi", start: 0x11000, end: 0x1107F };
pub const KAITHI: UnicodeBlock =
    UnicodeBlock { name: "Kaithi", start: 0x11080, end: 0x110CF };
pub const SORA_SOMPENG: UnicodeBlock =
    UnicodeBlock { name: "Sora Sompeng", start: 0x110D0, end: 0x110FF };
pub const CHAKMA: UnicodeBlock =
    UnicodeBlock { name: "Chakma", start: 0x11100, end: 0x1114F };
pub const MAHAJANI: UnicodeBlock =
    UnicodeBlock { name: "Mahajani", start: 0x11150, end: 0x1117F };
pub const SHARADA: UnicodeBlock =
    UnicodeBlock { name: "Sharada", start: 0x11180, end: 0x111DF };
pub const SINHALA_ARCHAIC_NUMBERS: UnicodeBlock = UnicodeBlock {
    name: "Sinhala Archaic Numbers",
    start: 0x111E0,
    end: 0x111FF,
};
pub const KHOJKI: UnicodeBlock =
    UnicodeBlock { name: "Khojki", start: 0x11200, end: 0x1124F };
pub const MULTANI: UnicodeBlock =
    UnicodeBlock { name: "Multani", start: 0x11280, end: 0x112AF };
pub const KHUDAWADI: UnicodeBlock =
    UnicodeBlock { name: "Khudawadi", start: 0x112B0, end: 0x112FF };
pub const GRANTHA: UnicodeBlock =
    UnicodeBlock { name: "Grantha", start: 0x11300, end: 0x1137F };
pub const TULU_TIGALARI: UnicodeBlock =
    UnicodeBlock { name: "Tulu-Tigalari", start: 0x11380, end: 0x113FF };
pub const NEWA: UnicodeBlock =
    UnicodeBlock { name: "Newa", start: 0x11400, end: 0x1147F };
pub const TIRHUTA: UnicodeBlock =
    UnicodeBlock { name: "Tirhuta", start: 0x11480, end: 0x114DF };
pub const SIDDHAM: UnicodeBlock =
    UnicodeBlock { name: "Siddham", start: 0x11580, end: 0x115FF };
pub const MODI: UnicodeBlock =
    UnicodeBlock { name: "Modi", start: 0x11600, end: 0x1165F };
pub const MONGOLIAN_SUPPLEMENT: UnicodeBlock = UnicodeBlock {
    name: "Mongolian Supplement",
    start: 0x11660,
    end: 0x1167F,
};
pub const TAKRI: UnicodeBlock =
    UnicodeBlock { name: "Takri", start: 0x11680, end: 0x116CF };
pub const MYANMAR_EXTENDED_C: UnicodeBlock =
    UnicodeBlock { name: "Myanmar Extended-C", start: 0x116D0, end: 0x116FF };
pub const AHOM: UnicodeBlock =
    UnicodeBlock { name: "Ahom", start: 0x11700, end: 0x1174F };
pub const DOGRA: UnicodeBlock =
    UnicodeBlock { name: "Dogra", start: 0x11800, end: 0x1184F };
pub const WARANG_CITI: UnicodeBlock =
    UnicodeBlock { name: "Warang Citi", start: 0x118A0, end: 0x118FF };
pub const DIVES_AKURU: UnicodeBlock =
    UnicodeBlock { name: "Dives Akuru", start: 0x11900, end: 0x1195F };
pub const NANDINAGARI: UnicodeBlock =
    UnicodeBlock { name: "Nandinagari", start: 0x119A0, end: 0x119FF };
pub const ZANABAZAR_SQUARE: UnicodeBlock =
    UnicodeBlock { name: "Zanabazar Square", start: 0x11A00, end: 0x11A4F };
pub const SOYOMBO: UnicodeBlock =
    UnicodeBlock { name: "Soyombo", start: 0x11A50, end: 0x11AAF };
pub const UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_A: UnicodeBlock =
    UnicodeBlock {
...
pub const PAU_CIN_HAU: UnicodeBlock =
    UnicodeBlock { name: "Pau Cin Hau", start: 0x11AC0, end: 0x11AFF };
pub const DEVANAGARI_EXTENDED_A: UnicodeBlock = UnicodeBlock {
    name: "Devanagari Extended-A",
    start: 0x11B00,
    end: 0x11B5F,
};
pub const SHARADA_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Sharada Supplement", start: 0x11B60, end: 0x11B7F };
pub const SUNUWAR: UnicodeBlock =
    UnicodeBlock { name: "Sunuwar", start: 0x11BC0, end: 0x11BFF };
pub const BHAIKSUKI: UnicodeBlock =
    UnicodeBlock { name: "Bhaiksuki", start: 0x11C00, end: 0x11C6F };
pub const MARCHEN: UnicodeBlock =
    UnicodeBlock { name: "Marchen", start: 0x11C70, end: 0x11CBF };
pub const MASARAM_GONDI: UnicodeBlock =
    UnicodeBlock { name: "Masaram Gondi", start: 0x11D00, end: 0x11D5F };
pub const GUNJALA_GONDI: UnicodeBlock =
    UnicodeBlock { name: "Gunjala Gondi", start: 0x11D60, end: 0x11DAF };
pub const TOLONG_SIKI: UnicodeBlock =
    UnicodeBlock { name: "Tolong Siki", start: 0x11DB0, end: 0x11DEF };
pub const MAKASAR: UnicodeBlock =
    UnicodeBlock { name: "Makasar", start: 0x11EE0, end: 0x11EFF };
pub const KAWI: UnicodeBlock =
    UnicodeBlock { name: "Kawi", start: 0x11F00, end: 0x11F5F };
pub const LISU_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Lisu Supplement", start: 0x11FB0, end: 0x11FBF };
pub const TAMIL_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Tamil Supplement", start: 0x11FC0, end: 0x11FFF };
pub const CUNEIFORM: UnicodeBlock =
    UnicodeBlock { name: "Cuneiform", start: 0x12000, end: 0x123FF };
...
pub const CYPRO_MINOAN: UnicodeBlock =
    UnicodeBlock { name: "Cypro-Minoan", start: 0x12F90, end: 0x12FFF };
...
pub const GURUNG_KHEMA: UnicodeBlock =
    UnicodeBlock { name: "Gurung Khema", start: 0x16100, end: 0x1613F };
pub const BAMUM_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Bamum Supplement", start: 0x16800, end: 0x16A3F };
pub const MRO: UnicodeBlock =
    UnicodeBlock { name: "Mro", start: 0x16A40, end: 0x16A6F };
pub const TANGSA: UnicodeBlock =
    UnicodeBlock { name: "Tangsa", start: 0x16A70, end: 0x16ACF };
pub const BASSA_VAH: UnicodeBlock =
    UnicodeBlock { name: "Bassa Vah", start: 0x16AD0, end: 0x16AFF };
pub const PAHAWH_HMONG: UnicodeBlock =
    UnicodeBlock { name: "Pahawh Hmong", start: 0x16B00, end: 0x16B8F };
pub const KIRAT_RAI: UnicodeBlock =
    UnicodeBlock { name: "Kirat Rai", start: 0x16D40, end: 0x16D7F };
pub const MEDEFAIDRIN: UnicodeBlock =
    UnicodeBlock { name: "Medefaidrin", start: 0x16E40, end: 0x16E9F };
pub const BERIA_ERFE: UnicodeBlock =
    UnicodeBlock { name: "Beria Erfe", start: 0x16EA0, end: 0x16EDF };
pub const MIAO: UnicodeBlock =
    UnicodeBlock { name: "Miao", start: 0x16F00, end: 0x16F9F };
pub const IDEOGRAPHIC_SYMBOLS_AND_PUNCTUATION: UnicodeBlock = UnicodeBlock {
    name: "Ideographic Symbols and Punctuation",
    start: 0x16FE0,
    end: 0x16FFF,
};
pub const TANGUT: UnicodeBlock =
    UnicodeBlock { name: "Tangut", start: 0x17000, end: 0x187FF };
pub const TANGUT_COMPONENTS: UnicodeBlock =
    UnicodeBlock { name: "Tangut Components", start: 0x18800, end: 0x18AFF };
pub const KHITAN_SMALL_SCRIPT: UnicodeBlock =
    UnicodeBlock { name: "Khitan Small Script", start: 0x18B00, end: 0x18CFF };
pub const TANGUT_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Tangut Supplement", start: 0x18D00, end: 0x18D7F };
pub const TANGUT_COMPONENTS_SUPPLEMENT: UnicodeBlock = UnicodeBlock {
    name: "Tangut Components Supplement",
    start: 0x18D80,
    end: 0x18DFF,
};
pub const KANA_EXTENDED_B: UnicodeBlock =
    UnicodeBlock { name: "Kana Extended-B", start: 0x1AFF0, end: 0x1AFFF };
pub const KANA_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock { name: "Kana Supplement", start: 0x1B000, end: 0x1B0FF };
pub const KANA_EXTENDED_A: UnicodeBlock =
    UnicodeBlock { name: "Kana Extended-A", start: 0x1B100, end: 0x1B12F };
pub const SMALL_KANA_EXTENSION: UnicodeBlock = UnicodeBlock {
    name: "Small Kana Extension",
    start: 0x1B130,
    end: 0x1B16F,
};
pub const NUSHU: UnicodeBlock =
    UnicodeBlock { name: "Nushu", start: 0x1B170, end: 0x1B2FF };
pub const DUPLOYAN: UnicodeBlock =
    UnicodeBlock { name: "Duployan", start: 0x1BC00, end: 0x1BC9F };
pub const SHORTHAND_FORMAT_CONTROLS: UnicodeBlock = UnicodeBlock {
    name: "Shorthand Format Controls",
    start: 0x1BCA0,
    end: 0x1BCAF,
};
pub const SYMBOLS_FOR_LEGACY_COMPUTING_SUPPLEMENT: UnicodeBlock =
    UnicodeBlock {
        name: "Symbols for Legacy Computing Supplement",
        start: 0x1CC00,
        end: 0x1CEBF,
    };
pub const MISCELLANEOUS_SYMBOLS_SUPPLEMENT: UnicodeBlock = UnicodeBlock {
...
pub const MUSICAL_SYMBOLS: UnicodeBlock =
    UnicodeBlock { name: "Musical Symbols", start: 0x1D100, end: 0x1D1FF };
...
pub const KAKTOVIK_NUMERALS: UnicodeBlock =
    UnicodeBlock { name: "Kaktovik Numerals", start: 0x1D2C0, end: 0x1D2DF };
pub const MAYAN_NUMERALS: UnicodeBlock =
    UnicodeBlock { name: "Mayan Numerals", start: 0x1D2E0, end: 0x1D2FF };
...
pub const SUTTON_SIGNWRITING: UnicodeBlock =
    UnicodeBlock { name: "Sutton SignWriting", start: 0x1D800, end: 0x1DAAF };
pub const LATIN_EXTENDED_G: UnicodeBlock =
    UnicodeBlock { name: "Latin Extended-G", start: 0x1DF00, end: 0x1DFFF };
...
pub const CYRILLIC_EXTENDED_D: UnicodeBlock =
    UnicodeBlock { name: "Cyrillic Extended-D", start: 0x1E030, end: 0x1E08F };
pub const NYIAKENG_PUACHUE_HMONG: UnicodeBlock = UnicodeBlock {
    name: "Nyiakeng Puachue Hmong",
    start: 0x1E100,
    end: 0x1E14F,
};
pub const TOTO: UnicodeBlock =
    UnicodeBlock { name: "Toto", start: 0x1E290, end: 0x1E2BF };
pub const WANCHO: UnicodeBlock =
    UnicodeBlock { name: "Wancho", start: 0x1E2C0, end: 0x1E2FF };
pub const NAG_MUNDARI: UnicodeBlock =
    UnicodeBlock { name: "Nag Mundari", start: 0x1E4D0, end: 0x1E4FF };
pub const OL_ONAL: UnicodeBlock =
    UnicodeBlock { name: "Ol Onal", start: 0x1E5D0, end: 0x1E5FF };
pub const TAI_YO: UnicodeBlock =
    UnicodeBlock { name: "Tai Yo", start: 0x1E6C0, end: 0x1E6FF };
pub const ETHIOPIC_EXTENDED_B: UnicodeBlock =
    UnicodeBlock { name: "Ethiopic Extended-B", start: 0x1E7E0, end: 0x1E7FF };
pub const MENDE_KIKAKUI: UnicodeBlock =
    UnicodeBlock { name: "Mende Kikakui", start: 0x1E800, end: 0x1E8DF };
pub const ADLAM: UnicodeBlock =
    UnicodeBlock { name: "Adlam", start: 0x1E900, end: 0x1E95F };
pub const INDIC_SIYAQ_NUMBERS: UnicodeBlock =
    UnicodeBlock { name: "Indic Siyaq Numbers", start: 0x1EC70, end: 0x1ECBF };
...
pub const MAHJONG_TILES: UnicodeBlock =
    UnicodeBlock { name: "Mahjong Tiles", start: 0x1F000, end: 0x1F02F };
pub const DOMINO_TILES: UnicodeBlock =
    UnicodeBlock { name: "Domino Tiles", start: 0x1F030, end: 0x1F09F };
pub const PLAYING_CARDS: UnicodeBlock =
    UnicodeBlock { name: "Playing Cards", start: 0x1F0A0, end: 0x1F0FF };
...
pub const EMOTICONS: UnicodeBlock =
    UnicodeBlock { name: "Emoticons", start: 0x1F600, end: 0x1F64F };
pub const ORNAMENTAL_DINGBATS: UnicodeBlock =
    UnicodeBlock { name: "Ornamental Dingbats", start: 0x1F650, end: 0x1F67F };
...
pub const ALCHEMICAL_SYMBOLS: UnicodeBlock =
    UnicodeBlock { name: "Alchemical Symbols", start: 0x1F700, end: 0x1F77F };
...
pub const CHESS_SYMBOLS: UnicodeBlock =
    UnicodeBlock { name: "Chess Symbols", start: 0x1FA00, end: 0x1FA6F };
...
pub const CJK_UNIFIED_IDEOGRAPHS_EXTENSION_J: UnicodeBlock = UnicodeBlock {
    name: "CJK Unified Ideographs Extension J",
    start: 0x323B0,
    end: 0x3347F,
};
pub const TAGS: UnicodeBlock =
    UnicodeBlock { name: "Tags", start: 0xE0000, end: 0xE007F };
...
/// Array of all Unicode blocks for lookup by constant name
pub const UNICODE_BLOCKS: [(&str, &UnicodeBlock); 346] = [
    ...
    ("ARABIC_EXTENDED_B", &ARABIC_EXTENDED_B),
    ...
    ("TODHRI", &TODHRI),
    ("LINEAR_A", &LINEAR_A),
    ("LATIN_EXTENDED_F", &LATIN_EXTENDED_F),
    ...
    ("YEZIDI", &YEZIDI),
    ("ARABIC_EXTENDED_C", &ARABIC_EXTENDED_C),
    ...
    ("TAKRI", &TAKRI),
    ("MYANMAR_EXTENDED_C", &MYANMAR_EXTENDED_C),
    ("AHOM", &AHOM),
    ("DOGRA", &DOGRA),
    ...
    ("DEVANAGARI_EXTENDED_A", &DEVANAGARI_EXTENDED_A),
    ("SHARADA_SUPPLEMENT", &SHARADA_SUPPLEMENT),
    ("SUNUWAR", &SUNUWAR),
    ("BHAIKSUKI", &BHAIKSUKI),
    ("MARCHEN", &MARCHEN),
    ...
    ("MAKASAR", &MAKASAR),
    ("KAWI", &KAWI),
    ("LISU_SUPPLEMENT", &LISU_SUPPLEMENT),
    ("TAMIL_SUPPLEMENT", &TAMIL_SUPPLEMENT),
    ("CUNEIFORM", &CUNEIFORM),
    ...
    ("EGYPTIAN_HIEROGLYPHS_EXTENDED_A", &EGYPTIAN_HIEROGLYPHS_EXTENDED_A),
    ...
    ("TANGUT_SUPPLEMENT", &TANGUT_SUPPLEMENT),
    ("TANGUT_COMPONENTS_SUPPLEMENT", &TANGUT_COMPONENTS_SUPPLEMENT),
    ("KANA_EXTENDED_B", &KANA_EXTENDED_B),
    ("KANA_SUPPLEMENT", &KANA_SUPPLEMENT),
    ("KANA_EXTENDED_A", &KANA_EXTENDED_A),
    ("SMALL_KANA_EXTENSION", &SMALL_KANA_EXTENSION),
    ("NUSHU", &NUSHU),
    ("DUPLOYAN", &DUPLOYAN),
    ...
    ("MISCELLANEOUS_SYMBOLS_SUPPLEMENT", &MISCELLANEOUS_SYMBOLS_SUPPLEMENT),
    ("ZNAMENNY_MUSICAL_NOTATION", &ZNAMENNY_MUSICAL_NOTATION),
    ...
    ("LATIN_EXTENDED_G", &LATIN_EXTENDED_G),
    ("GLAGOLITIC_SUPPLEMENT", &GLAGOLITIC_SUPPLEMENT),
    ("CYRILLIC_EXTENDED_D", &CYRILLIC_EXTENDED_D),
    ...
    ("OL_ONAL", &OL_ONAL),
    ("TAI_YO", &TAI_YO),
    ("ETHIOPIC_EXTENDED_B", &ETHIOPIC_EXTENDED_B),
...
pub fn find_unicode_block(c: char) -> Option<UnicodeBlock> {
    match c {
        ...
        '\u{1400}' ..= '\u{167F}' => {
            Some(UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS)
        }
        ...
        '\u{18B0}' ..= '\u{18FF}' => {
            Some(UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED)
        }
        ...
        '\u{1AB0}' ..= '\u{1AFF}' => {
            Some(COMBINING_DIACRITICAL_MARKS_EXTENDED)
        }
        ...
        '\u{1DC0}' ..= '\u{1DFF}' => {
            Some(COMBINING_DIACRITICAL_MARKS_SUPPLEMENT)
        }
        ...
        '\u{20D0}' ..= '\u{20FF}' => {
            Some(COMBINING_DIACRITICAL_MARKS_FOR_SYMBOLS)
        }
        ...
        '\u{11AB0}' ..= '\u{11ABF}' => {
            Some(UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_A)
        }
        '\u{11AC0}' ..= '\u{11AFF}' => Some(PAU_CIN_HAU),
        '\u{11B00}' ..= '\u{11B5F}' => Some(DEVANAGARI_EXTENDED_A),
        '\u{11B60}' ..= '\u{11B7F}' => Some(SHARADA_SUPPLEMENT),
        ...
        '\u{11DB0}' ..= '\u{11DEF}' => Some(TOLONG_SIKI),
        ...
        '\u{13430}' ..= '\u{1345F}' => {
            Some(EGYPTIAN_HIEROGLYPH_FORMAT_CONTROLS)
        }
        ...
        '\u{16EA0}' ..= '\u{16EDF}' => Some(BERIA_ERFE),
        '\u{16F00}' ..= '\u{16F9F}' => Some(MIAO),
        '\u{16FE0}' ..= '\u{16FFF}' => {
            Some(IDEOGRAPHIC_SYMBOLS_AND_PUNCTUATION)
        }
        ...
        '\u{18D80}' ..= '\u{18DFF}' => Some(TANGUT_COMPONENTS_SUPPLEMENT),
        ...
        '\u{1CC00}' ..= '\u{1CEBF}' => {
            Some(SYMBOLS_FOR_LEGACY_COMPUTING_SUPPLEMENT)
        }
        '\u{1CEC0}' ..= '\u{1CEFF}' => Some(MISCELLANEOUS_SYMBOLS_SUPPLEMENT),
        ...
        '\u{1EE00}' ..= '\u{1EEFF}' => {
            Some(ARABIC_MATHEMATICAL_ALPHABETIC_SYMBOLS)
        }
        ...
        '\u{1F300}' ..= '\u{1F5FF}' => {
            Some(MISCELLANEOUS_SYMBOLS_AND_PICTOGRAPHS)
        }
        ...
        '\u{1F900}' ..= '\u{1F9FF}' => {
            Some(SUPPLEMENTAL_SYMBOLS_AND_PICTOGRAPHS)
        }
        '\u{1FA00}' ..= '\u{1FA6F}' => Some(CHESS_SYMBOLS),
        '\u{1FA70}' ..= '\u{1FAFF}' => {
            Some(SYMBOLS_AND_PICTOGRAPHS_EXTENDED_A)
        }
        '\u{1FB00}' ..= '\u{1FBFF}' => Some(SYMBOLS_FOR_LEGACY_COMPUTING),
        '\u{20000}' ..= '\u{2A6DF}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B)
        }
        '\u{2A700}' ..= '\u{2B73F}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_C)
        }
        '\u{2B740}' ..= '\u{2B81F}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_D)
        }
        '\u{2B820}' ..= '\u{2CEAF}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_E)
        }
        '\u{2CEB0}' ..= '\u{2EBEF}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_F)
        }
        '\u{2EBF0}' ..= '\u{2EE5F}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_I)
        }
        '\u{2F800}' ..= '\u{2FA1F}' => {
            Some(CJK_COMPATIBILITY_IDEOGRAPHS_SUPPLEMENT)
        }
        '\u{30000}' ..= '\u{3134F}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_G)
        }
        '\u{31350}' ..= '\u{323AF}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_H)
        }
        '\u{323B0}' ..= '\u{3347F}' => {
            Some(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_J)
        }
        ...
        '\u{100000}' ..= '\u{10FFFF}' => {
            Some(SUPPLEMENTARY_PRIVATE_USE_AREA_B)
        }
        _ => None,
    }
}
